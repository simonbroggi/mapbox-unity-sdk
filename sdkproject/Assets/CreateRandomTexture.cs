...
{
	public class CreateRandomTexture : EditorWindow
	{

		[MenuItem("Mapbox/Create Random Texture")]
		public static void ShowWindow()
		{
			EditorWindow.GetWindow(typeof(CreateRandomTexture));
		}

		public int seed;
		public string saveFileName = "RandomTexture";

		public Texture2D texture;

		private const int TEXTURE_RES = 4096;

		private void CreateTexture()
		{
			Random.InitState(seed);
			texture = new Texture2D(TEXTURE_RES, TEXTURE_RES, TextureFormat.ARGB32, false);
		...
		{
			var path = EditorUtility.SaveFilePanel("Save texture as PNG", "Assets", "RandomTexture.png", "png");
			if (path.Length == 0)
			{
				return;
			}
		...
		void OnGUI()
		{
			...
			EditorGUILayout.LabelField("Random Texture Generator", titleStyle, GUILayout.Height(100));
			...
			GUILayout.Box(texture, boxStyle, GUILayout.Width(300), GUILayout.Height(300), GUILayout.ExpandWidth(true), GUILayout.ExpandHeight(true));
