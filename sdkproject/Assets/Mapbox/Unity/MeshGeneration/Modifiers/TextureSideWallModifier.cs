namespace Mapbox.Unity.MeshGeneration.Modifiers
{
	...
	public class TextureSideWallModifier : MeshModifier
	{
		...
		public override void Run(VectorFeatureUnity feature, MeshData md, UnityTile tile = null)
		{
			...
			//create a new string from the last 3 characters...
			//TODO: catch edge case where this fails...
			string textureSelectionRefStringShort =  textureSelectionRefString.Substring(textureSelectionRefString.Length - 3);

			//attempt to convert this string into an int...
			int textureSelectionRefValue = 0;
			if (Int32.TryParse(textureSelectionRefStringShort, out textureSelectionRefValue))
			{
				facadeIndex = (int)Mathf.Repeat(textureSelectionRefValue, _options.atlasInfo.Textures.Count - 1);
			}
			else
			{
